            ...
            <FormControl
                ...
                {selectProject !== "" ?
                    <Box flexBasis={'100%'}>
                        ...
                        <Typography display={'inline'} sx={{flexBasis:'200px',color:'#1a1ad2',fontWeight:'600',ml:2}}>Project Title: </Typography>
                        <Typography sx={{display:'inline'}}>{admin.selectedProjectDetails.title}</Typography>
                        <Box flexBasis={'100%'}></Box>
                        <Typography display={'inline'} sx={{flexBasis:'200px',color:'#1a1ad2',fontWeight:'600',ml:2}}>Project Description: </Typography>
                        <Typography sx={{display:'inline'}}>{<div style={{display:'inline'}} dangerouslySetInnerHTML={{ __html: htmlDecode(admin.selectedProjectDetails.description)}}></div>}</Typography>
                        <Box flexBasis={'100%'}></Box>
                        <Typography display={'inline'} sx={{flexBasis:'200px',color:'#1a1ad2',fontWeight:'600',ml:2}}>Project Created Date: </Typography>
                        <Typography sx={{display:'inline'}}><Moment format="DD/MMM/YYYY HH:MMA">{admin.selectedProjectDetails.date}</Moment></Typography>
                        </Box>
